    ...
    <body>
        ...
        <c:choose>
            <c:when test="${empty action}" >
                ...
                Não <input type="radio" name="dependentePedagogia.matriculado" value="nao" <c:if test="${dependentePedagogia.matriculado == 'nao'}">checked="checked"</c:if>>
                Por que não matriculado?:<input type="text" name="dependentePedagogia.porqueNaoMatriculado" value="${dependentePedagogia.porqueNaoMatriculado}" /><br/>
                ...
                Não <input type="radio" name="dependentePedagogia.apresentaDefasagemEscolar" value="nao" <c:if test="${dependentePedagogia.apresentaDefasagemEscolar == 'nao'}"> checked="checked"</c:if>/><br/>
                ...
                Não <input type="radio" name="dependentePedagogia.apresentaDeficuldadeAprendizagem" value="nao" <c:if test="${dependentePedagogia.apresentaDeficuldadeAprendizagem == 'nao'}"> checked="checked"</c:if>/><br/>
